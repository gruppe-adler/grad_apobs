...

{
    ...
    [_startingPosASL, _endPosASL, [1,0,0,1]] call ace_common_fnc_addLineToDebugDraw; // Debug scan lines
...
[
    ...
    [_unit, _connector, _rearpack, _attachPosModel],
    {
        ...
        [ace_common_fnc_setVectorDirAndUp, [_connector, _dirAndUp], _connector] call CBA_fnc_targetEvent;
        _connector setVariable [QGVAR(sink), _rearpack, true];
